...
def prepare_response_webwalker(original_task: str, inner_messages, reformulation_model: Model) -> str:
    messages = [
        {
            "role": MessageRole.SYSTEM,
            "content": [
...
Your answer should cover as many of the questions as possible.
Provide all the information required by the question.
""",
                }
            ],
        }
